...
/***/ function(module, exports, __webpack_require__) {
	...
	var _imageComponent = __webpack_require__(7);
	
	var _imageComponent2 = _interopRequireDefault(_imageComponent);
	
	var _imageDetailComponent = __webpack_require__(8);
	
	var _imageDetailComponent2 = _interopRequireDefault(_imageDetailComponent);
	...
	var app = new _vue2.default({
	  ...
	  components: {
	    ...
	    imageDetailComponent: _imageDetailComponent2.default
	  },
	  computed: (0, _vuex.mapGetters)(['images', 'selectedIndex', 'selectedImage', 'hasSelectedImage']),
	  methods: (0, _vuex.mapActions)(['fetchImages']),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mutations = {
	  ...
	  IMAGE_SELECTED: function IMAGE_SELECTED(state, index) {
	    state.selectedIndex = index;
	  },
	  RELEASE_INDEX: function RELEASE_INDEX(state) {
	    state.selectedIndex = null;
	  },
	  SUCCESS_POST_COMMENT: function SUCCESS_POST_COMMENT(state) {},
	  FAIL_POST_COMMENT: function FAIL_POST_COMMENT(state) {}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.postComment = exports.releaseIndex = exports.setSelectedIndex = exports.fetchImages = undefined;
	...
	var IMAGES_API_PATH = '/api/v1/images';
	var COMMENTS_API_PATH = '/api/v1/images/__IMAGE_ID__/comments';
	...
	var setSelectedIndex = exports.setSelectedIndex = function setSelectedIndex(_ref2, index) {
	...
	var releaseIndex = exports.releaseIndex = function releaseIndex(_ref3) {
	...
	var postComment = exports.postComment = function postComment(_ref4, comment) {
	  var commit = _ref4.commit;
	  var state = _ref4.state;
	
	  var selectedImage = state.images[state.selectedIndex];
	  _jQuery2.default.ajax({
...
/***/ function(module, exports) {
	...
	var images = exports.images = function images(state) {
	  return state.images;
	};
	var selectedIndex = exports.selectedIndex = function selectedIndex(state) {
	  return state.selectedIndex;
	};
	var selectedImage = exports.selectedImage = function selectedImage(state) {
	  return state.images[state.selectedIndex] || {};
	};
	var hasSelectedImage = exports.hasSelectedImage = function hasSelectedImage(state) {
	  return !!state.images[state.selectedIndex];
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: Object.assign((0, _vuex.mapActions)(['setSelectedIndex']), {
	    onSelectImage: function onSelectImage(index) {
	      this.setSelectedIndex(index);
	    }
	  })
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: Object.assign({
	    ...
	    onClickPost: function onClickPost() {
	  ...
	  }, (0, _vuex.mapActions)(['releaseIndex', 'postComment']))
	};
